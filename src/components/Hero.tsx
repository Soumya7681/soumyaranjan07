...
const Hero: React.FC = () => {
    ...
    const handleDownload = () => {
        ...
        link.href = "/TanushreeCV.pdf";
        link.setAttribute("download", "Tanushreeranjan_Resume.pdf");
            ...
            <div className="container mx-auto px-6 pt-24 pb-12 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-6rem)]">
                    ...
                    <div className="space-y-8 lg:pr-8">
                        {/* Status Badge */}
                        <div className="flex items-center gap-2 w-fit px-4 py-2 bg-accent/10 border border-accent/20 rounded-full backdrop-blur-sm">
                            ...
                            <span className="text-xs text-foreground/60">Bangalore, India</span>
                        </div>

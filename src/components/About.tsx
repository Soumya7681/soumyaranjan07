...
const About: React.FC = () => {
  ...
  const stats: Stat[] = [
    { value: "1.6+", label: "Years Experience", icon: Calendar },
                ...
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed">
                      With <span className="text-accent font-semibold">1.6 years</span> of hands-on experience, 
